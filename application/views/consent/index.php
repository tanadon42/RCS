...
function search_data() {
    ...
    $.ajax({
        type: "post",
        url: "<?php echo base_url(); ?>/Rcs_Controller/search_data",
        data: {
            "type": type,
            ...
            if (data.length == 0) {
                ...
                data.forEach((row, i) => {
                    ...
                    if (row.frm_status == 1) {
                        ...
                        manage_txt =
                            '<a href="<?php echo base_url(); ?>Rcs_Controller/form_detail/' + row
                            .frm_id +
                            '"><button type="button" class="btn btn-dark btn-addon btn-sm m-b-10 m-l-5"><i class="ti-eye"></i>View</button></a>';
                        ...
                        manage_txt =
                            ...
                            '"><button type="button" class="btn btn-dark btn-addon btn-sm m-b-10 m-l-5"><i class="ti-eye"></i>View</button></a>';
                        manage_txt +=
                            ' <a href="<?php echo base_url(); ?>Rcs_Form_Controller/export_pdf/' +
                            row.frm_id +
                            '"> <button type="button" class="btn btn-danger btn-addon btn-sm m-b-10 m-l-5" ><i class="ti-download"></i>PDF</button></a>';
                    }
...
<div class="col-lg-12">
    <div class="card-header p-3 mb-2 bg-primary text-white rounded"> <b>รายการแบบฟอร์มขอพนักงาน (Personnel Requisition
            Form List)</b> </div>
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="table-responsive mt-5">
                <table class="table table-bordered dashboard" id="dashboard" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            <th>#</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td id="manage">
                                <a
                                    href="<?php echo base_url(); ?>Rcs_Controller/form_detail/<?php echo $row->frm_id; ?>">
                                    <button type="button" class="btn btn-dark btn-addon btn-sm m-b-10 m-l-5"><i
