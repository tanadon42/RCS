...
function search_data() {
    ...
    $.ajax({
        type: "post",
        url: "<?php echo base_url(); ?>/Rcs_Approve_Controller/search_data",
        data: {
            "type": type,
...
<div class="col-lg-12">
    <div class="card-header p-3 mb-2 bg-primary text-white rounded"> <b>รายการอนุมัติแบบฟอร์มขอพนักงาน (Personnel Requisition Form Approve List)</b> </div>
    <div class="card">
        <!-- fillter -->
                ...
                <table class="table table-bordered dashboard">
                    ...
                    <?php
                        ...
                        <tr>
                            ...
                            <td id="manage">
                                <a
                                    href="<?php echo base_url(); ?>Rcs_Approve_Controller/form_approve/<?php echo $row->frm_id; ?>">
