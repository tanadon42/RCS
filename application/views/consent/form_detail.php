...
<div class="col-lg-12">
    <div class="card-header p-3 mb-2 bg-primary text-white rounded"> <b>ดูรายละเอียดแบบฟอร์มขอพนักงาน (Personnel
            Requisition
            Form Details)</b>
    </div>
    <?php
    ...
    <div class="card">
        <div class="form-row">
            <div class="col-12 col-sm-12">
                ...
                <div class="row">
                    <div lass="col-2">
                        <a href="<?php echo base_url(); ?>Rcs_Controller/index">
                            <button type="button" class="btn btn-default btn-addon btn-md m-b-10 m-l-5"
                                style="float: left;"><i class="ti-back-left"></i>Back</button>
                        </a>
                    </div>
                </div>
