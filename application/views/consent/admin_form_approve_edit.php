...
<div class="col-lg-12">
    <div class="card-header p-3 mb-2 bg-primary text-white rounded"> <b>อนุมัติแบบฟอร์มขอพนักงานสำหรับผู้ดูแลระบบ (Personnel Requisition Form Approve for Admin)</b>
    </div>
    <div class="card">
    ...
    <div class="card">
        ...
        <div class="row">
            <div lass="col-2">
                <a href="<?php echo base_url(); ?>Rcs_Admin_Controller/approve">
            ...
            if (isConfirm) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        setTimeout(() => {
                            window.location =
                                "<?php echo base_url(); ?>Rcs_Admin_Controller/index";
